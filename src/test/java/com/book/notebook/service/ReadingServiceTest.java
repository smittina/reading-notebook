...
public class ReadingServiceTest {
    ...
    private static List<Reading> readingsByYear = new ArrayList<>();
    ...
    public void getAllYearsOfReadingsTest() {
        ...
        expected.put(2023, Long.valueOf(2));
        expected.put(2024, Long.valueOf(1));
        expected.put(2025, Long.valueOf(1));
    ...
    public void getAllMonthsOfReadingsByYearTest() {
        // given
        Map<Integer,Long> expected = new HashMap<>();
        expected.put(1, Long.valueOf(0));
        expected.put(2, Long.valueOf(0));
        expected.put(3, Long.valueOf(0));
        expected.put(4, Long.valueOf(0));
        expected.put(5, Long.valueOf(0));
        expected.put(6, Long.valueOf(0));
        expected.put(7, Long.valueOf(0));
        expected.put(8, Long.valueOf(0));
        expected.put(9, Long.valueOf(1));
        expected.put(10, Long.valueOf(1));
        expected.put(11, Long.valueOf(0));
        expected.put(12, Long.valueOf(0));
